...
export default function Skills() {
  return (
    <section id="skills" className="py-16 sm:py-24 md:py-32 bg-dark-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          >
            <motion.p className="text-xs sm:text-sm font-medium tracking-wider uppercase mb-3 text-neon-purple">
              My Expertise
            </motion.p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {skills.map((skill, index) => (
              <motion.div
                ...
                className="group relative p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-dark-800/50 hover:bg-dark-700/50 border border-white/5 hover:border-white/10 transition-all duration-300"
              >
                <div
                ...
                <div className="relative">
                  ...
                  <h3 className="text-sm sm:text-base md:text-lg font-semibold font-poppins mb-1 text-white">
                    {skill.name}
                  </h3>

                  <p className="text-xs mb-3 sm:mb-4 hidden sm:block text-gray-400">
                    {skill.description}
                  </p>

                  {/* Progress Bar */}
                  <div className="h-1 sm:h-1.5 rounded-full overflow-hidden bg-dark-600">
                    <motion.div
